...
| **CRM integration** | Reading and writing AWS Partner Central opportunities from CRM records — field mapping, opportunity creation/submission, and reverse-sync of AWS-side changes back into the CRM. |
